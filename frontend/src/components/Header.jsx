      ...
      <div className="header__container">
        ...
        >
          <ul className="header__menu">
            ...
            <li className="header__menu-item">
              ...
              >
                <li>
                  <NavLink to="/dla-klienta/pompy-ciepla">Pompy ciepła</NavLink>
                </li>
                <li>
                  <NavLink to="/dla-klienta/klimatyzacje">Klimatyzacje</NavLink>
                </li>
                <li>
                  <NavLink to="/dla-klienta/ogrzewanie-podlogowe">
                    Ogrzewanie podłogowe
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/dla-klienta/wentylacje">Wentylacje</NavLink>
                </li>
                <li>
                  <NavLink to="/dla-klienta/wod-kan">
                    Instalacje Wod-Kan
                  </NavLink>
                </li>
              </ul>
            ...
            <li className="header__menu-item">
              ...
              >
                <li>
                  <NavLink to="/przemysl/farmy-fotowoltaiczne">
                    Farmy fotowoltaiczne
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/przemysl/klimatyzacja">
                    Klimatyzacja przemysłowa
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/przemysl/wentylacja">
                    Wentylacja przemysłowa
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/przemysl/wod-kan">Wod-Kan</NavLink>
                </li>
              </ul>
            </li>
          ...
          <div className="header__mobile-contact">
            ...
            <a href="mailto:biuro@eco-sys.pl">
              <FaEnvelope /> biuro@eco-sys.pl
            </a>
          </div>
        </nav>
        ...
        <div className="header__actions">
          <div className="header__contact-desktop">
            ...
            <a href="mailto:biuro@eco-sys.pl" className="contact-link">
              <FaEnvelope className="icon" /> biuro@eco-sys.pl
            </a>
          </div>
